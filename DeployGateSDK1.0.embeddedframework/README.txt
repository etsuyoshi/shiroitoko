...
You need a Author Name and API Key to use the SDK. It is provided on DeployGate Document (https://stg.deploygate.com/docs/ios_sdk).
...
4. Get Application Owner Name and API Key on https://stg.deploygate.com/docs/ios_sdk after Login.
